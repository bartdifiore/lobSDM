...
## Get data
#----------------------------------
all_mod_data<- readRDS(here::here("Data/Derived/all_model_data_adult.rds"))
...
saveRDS(fit_base, here::here("AdultFit_Base.rds"))
...
saveRDS(fit_sp, here::here("AdultFit_Sp.rds"))
...
tictoc::toc()
saveRDS(fit_spst, here::here("AdultFit_SpST.rds"))
...
saveRDS(fit_spst_ar1, here::here("AdultFit_SpST_AR1T.rds"))
sanity(fit_spst_ar1)
fit_spst_ar1
...
# Read in fits?
fit_base <- readRDS(here::here("AdultFit_Base.rds"))
fit_sp <- readRDS(here::here("AdultFit_Sp.rds"))
fit_spst <- readRDS(here::here("AdultFit_SpST.rds"))
fit_spst_ar1 <- readRDS(here::here("AdultFit_SpST_AR1T.rds"))
...
adult_out<- fit_preds$Pred_Map[[start]] + 
...
ggsave(here::here("Figures/AdultExamplePredDistAbundance.jpg"), adult_out, dpi = 300)
...
write_rds(proj_dat_temp, here::here("Data/Derived/adult_projected_biomass.rds"), compress = "gz")
...
proj_ind_plot <- ggplot() +
  ...
  xlab("Year") +
  ylab("Adult Relative Biomass Index") +
