...
saveRDS(fit_base, here::here("JuveFit_Base.rds"))
...
saveRDS(fit_sp, here::here("JuveFit_Sp.rds"))
...
tictoc::toc()
saveRDS(fit_spst, here::here("JuveFit_SpST.rds"))
...
tictoc::toc()
saveRDS(fit_spst_ar1, here::here("JuveFit_SpST_AR1T.rds"))
...
# Read in fits?
fit_base <- readRDS(here::here("JuveFit_Base.rds"))
fit_sp <- readRDS(here::here("JuveFit_Sp.rds"))
fit_spst <- readRDS(here::here("JuveFit_SpST.rds"))
fit_spst_ar1 <- readRDS(here::here("JuveFit_SpST_AR1T.rds"))
