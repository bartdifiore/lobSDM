...
writeRaster(
  ...
  str_c(
    var_path, 
    cmip_var,"_", "_GLORYs_bias_corrected_5thpercentile.grd"), 
  overwrite = T)
writeRaster(
  ensemble_means, 
  str_c(
    var_path, 
    cmip_var,"_", "_GLORYs_bias_corrected_mean.grd"), 
  overwrite = T)
writeRaster(
  ensemble_95th, 
    str_c(
      var_path, 
      cmip_var,"_", "_GLORYs_bias_corrected_95thpercentile.grd"), 
  overwrite = T)
...
ggplot(masked_ensembles) +
  geom_line(aes(date, y = bot_temp, color = ensemble_stat), alpha = 0.8, linewidth = 0.5) +
